...
public class LocationController {
    ...
    public ResponseEntity<List<Location>> findAll(){
        URI uri = URI.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/location/all").toUriString());
        return ResponseEntity.created(uri).body(locationService.findAll());
    }
