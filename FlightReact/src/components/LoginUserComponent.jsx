...
function LoginUserComponent(props) {
    ...
    return (
       <div className="font">
           <h1 style={{fontWeight: 'bold' ,textAlign: 'center' ,margin: "20px"}}>User Login</h1>

           <div className="col-sm-6 offset-sm-3">
           <input type="text" placeholder="User Name" id="userName" value={userName} onChange={(event)=>setuserName(event.target.value)} className="form-control" />
           <br />
