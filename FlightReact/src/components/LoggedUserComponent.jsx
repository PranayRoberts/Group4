...
function LoggedUserComponent(props) {
  ...
  async function search() {
    ...
    let result = await fetch(`http://localhost:8080/admin/search_flights/?departureLocation=${departure}&arrivalLocation=${arrival}`, {
      method: "GET",
      headers: {
  ...
  return (
    <div className="font">
      ...
      {searchData.length > 0 && (
        searchData.map((obj) => <ListFlightsComponent data={obj} key = {obj.id} />)
      )}
